...
const forecast = (latitude, longitude, callback) => {
    ...
    .then(function (res) {
        if(res.data.error){
            ...
            callback(undefined, `${res.data.current.weather_descriptions[0]}. It is crurently ${res.data.current.temperature} degress out. It feels like ${res.data.current.feelslike} degress out`);
        }
    })
    .catch(function (err){
